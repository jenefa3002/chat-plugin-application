...
from .consumers import OnlineStatusConsumer, NotificationConsumer, CallNotificationConsumer

websocket_urlpatterns = [
    re_path(r'ws/call_notifications/$', CallNotificationConsumer.as_asgi()),
